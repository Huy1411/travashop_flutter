...
import 'package:trevashop_v2/apis/database_helper.dart';
                  ...
                  children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                  padding:
                                      EdgeInsets.symmetric(vertical: 10.0)),
                              textFromField(
                                controllerP: usernameController,
                                icon: Icons.email,
                                password: false,
                              ...
                              textFromField(
                                controllerP: passwordController,
                                icon: Icons.vpn_key,
                                password: true,
                                email:
                    ...
                    tap == 0
                        ? InkWell(
                            ...
                            onTap: () {
                              databaseHelper.Login(usernameController.text.trim(), passwordController.text.trim());
                              Navigator.pop(context,true);
                              if(databaseHelper.isLogin == true){
                                setState(() {
                                  tap = 1;
                                });
                              }else{
...
class textFromField extends StatelessWidget {
  ...
  textFromField({this.email, this.icon, this.inputType, this.password,this.controllerP});
